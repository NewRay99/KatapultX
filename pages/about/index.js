...
export const aboutData = [
  ...
  },
  {
    ...
    info: [
      {
        title:
          "Everything we do is purposeful having a positive impact to the lives of people, their community and society.",
      },
    ],
  },
  {
    ...
    info: [
      {
        title:
          "We bring corporations together to amplify, accelerate and drive change.",
        icons: [{ id: "1", icon: <FaHtml5 /> }],
      },
    ],
  },
];
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center z-10">
          <motion.h2
            ...
            className="h2"
          >
            <span className="text-accent">Empowering</span> Talent: A Path to
            Excellence.
          </motion.h2>
          <motion.p
        ...
        >
          ...
          <div className="py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start h-40 hover:overflow-scroll md:h-auto md:overflow-auto ">
